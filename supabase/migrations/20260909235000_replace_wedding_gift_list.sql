...
WITH requested(sort_order, title, price) AS (
  VALUES
    (1, '✈️ Uma experiência para a nossa Lua de Mel', 500.00::numeric),
    (2, '🍟 Air Fryer para nossa casa', 320.00::numeric),
    (3, '🛋️ Um detalhe especial para o nosso sofá', 450.00::numeric),
    ...
    (9, '🧺 Nossa máquina de lavar', 430.00::numeric),
    (10, '🍷 Jantar romântico dos recém-casados', 350.00::numeric),
    (11, '📺 Um novo capítulo para a nossa sala', 480.00::numeric),
    (12, '🍲 Panela de pressão elétrica', 350.00::numeric),
    (13, '🏠 Um toque especial para o nosso lar', 400.00::numeric),
    ...
    (19, '🪑 Mesa de jantar para a nossa casa', 400.00::numeric),
    (20, '🥂 Kit de taças para momentos especiais', 200.00::numeric),
    (21, '❄️ Um novo conforto para a nossa cozinha', 450.00::numeric),
